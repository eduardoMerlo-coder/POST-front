...
export const SidePanel = () => {
  ...
  return (
    <aside className="max-sm:fixed top-0 z-50 left-0 h-full w-1/4 bg-white p-2">
      ...
      <details name="my-accordion" open={!!useMatch("/product/*")}>
        ...
        <div className="flex flex-col px-3">
          <div
            className="flex items-center gap-2 p-2 rounded-lg hover:bg-sky-100/50"
          ...
          >
            <input
              ...
              name="plan"
              type="radio"
              checked={!!useMatch("/product/category")}
              readOnly
            />
            <label
              className="w-full hover:cursor-pointer "
